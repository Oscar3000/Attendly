        ...
        {onSearchChange && (
          <div className="relative w-full sm:w-64">
            <input
              ...
              className="w-full pl-9 pr-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[rgb(192,122,84)] focus:border-transparent"
            />
            <svg
